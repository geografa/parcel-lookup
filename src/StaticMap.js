...
const StaticMapImage = ({ lng, lat }) => {
  ...
  const staticImageUrl = `https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v12/static/pin-s+ea580b(${lng},${lat})/${lng},${lat},17,0,0/${width}x${height}@2x?access_token=${accessToken}`;
